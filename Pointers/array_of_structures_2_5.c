...
BANDS bands_4g = {{1, 2, 3, 4, 5}, {{1, 5, 9, 13, 17}, {2, 6, 10, 14, 18}, {3, 7, 11, 15, 19}, {4, 8, 12, 16, 20}}, {{
...
//		for(value_index = 0; value_index < NUMBER_OF_VALUES; value_index++)
		{
//			bands_4g.value[band_index].value1 = value_value++;
//			bands_4g.value[band_index].value2 = value_value++;
			printf("bands_4g.value[%d].value1= %d\n", band_index,bands_4g.value[band_index].value1);
			printf("bands_4g.value[%d].value2= %d\n", band_index,bands_4g.value[band_index].value2);
		}
	}
